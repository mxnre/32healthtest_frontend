          ...
          <div className="flex justify-center items-center">
            <div className="flex items-center">
              ...
              <DatePicker
                ...
                onChange={(date, e) => formik.setFieldValue("startDate", date)}
              />
            </div>
            <div className="flex items-center">
              ...
              <DatePicker
                ...
                onChange={(date, e) => formik.setFieldValue("endDate", date)}
              />
            </div>
          </div>
        </div>
        <div className="third flex justify-start mt-14">
          <div className="mr-12 w-60 h-16 text-[36px] font-bold text-green-800 shadow-2xl">
            Maximums
          </div>
          <div>
            <div className="flex">
